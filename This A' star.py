...
pygame.display.set_caption("A* Path Finding Algo")    # at this point, some window pops up and disappears
...
class Spot:        # to keep track of the spots
...
def h(p1, p2):                       #method for manhattan distance? ig 
    x1, y1 = p1
    x2, y2 = p2
